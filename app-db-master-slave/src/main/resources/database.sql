...
DROP DATABASE IF EXISTS demo_main_slave1_db;
CREATE DATABASE demo_main_slave1_db CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci';
DROP DATABASE IF EXISTS demo_main_slave2_db;
CREATE DATABASE demo_main_slave2_db CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci';
*/
