...
public class <%=JavaName%>Controller implements IController<String, <%=TabName%>> {
    ...
    @ResponseBody
    @Override
    public Result<Void> update(final String id, final String body) {
...
/*
    ...
    @ResponseBody
    @Override
    public Result<Void> deleteById(final String id) {
...
/*
    ...
    @ResponseBody
    @Override
    public Result<Void> deleteByUid(final String id, final String uid) {
...
*/
    ...
    @ResponseBody
    @Override
    public Result<Void> markDeleteById(final String id) {
...
/*
    ...
    @ResponseBody
    @Override
    public Result<Void> markDeleteByUid(final String id, final String uid) {
...
*/
    ...
    @ResponseBody
    @Override
    public Result<Void> markDeleteByIds(final Set<String> body) {
