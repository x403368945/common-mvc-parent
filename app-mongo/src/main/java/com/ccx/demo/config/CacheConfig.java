 ...
 */
@Configuration
@ConditionalOnExpression("'beta'.equals('${app.env}') || 'prod'.equals('${app.env}')") // 测试环境 和 生产环境启用该配置
public class CacheConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory factory) {
        ...
        RedisSerializationContext.SerializationPair<Object> serializeValues = RedisSerializationContext.SerializationPair.fromSerializer(new FastJsonRedisSerializer<Object>(Object.class) {
            @Override
