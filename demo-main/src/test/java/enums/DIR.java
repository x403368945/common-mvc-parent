...
public enum DIR {
    ...
    EXCEL("test/excel目录", FILES.absolute("excel")),
    HTML("test/html目录", FILES.absolute("html")),
    TEMP("临时文件存储目录", FILES.absolute("temp")),;
    /**
     * 枚举属性说明
     */
     ...
     * @return File 文件对象
     */
    public String write(String content, String... names) {
