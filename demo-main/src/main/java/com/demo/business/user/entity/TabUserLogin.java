...
import static com.demo.business.user.entity.QTabUserLogin.tabUserLogin;
import static com.mvc.entity.base.Prop.RANGE_DATE;
...
// Enum End : DB Start *************************************************************************************************
    ...
    public QdslWhere where() {
        final com.demo.business.user.entity.QTabUserLogin q = tabUserLogin;
        return QdslWhere.of()
                .and(timestampRange, () -> {
