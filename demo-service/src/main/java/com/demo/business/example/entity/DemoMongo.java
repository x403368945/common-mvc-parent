...
import static com.demo.business.example.entity.QDemoMongo.demoMongo;
import static com.mvc.entity.base.Prop.SORTS;
...
public class DemoMongo implements
        ...
        IWhere<Update, QdslWhere> // 声明用于实现构建 com.mvc.dao.IViewRepository 需要的查询条件
{
    /**
     * 数据ID，主键自增
     */
