package com.demo.business.example.dao.mongo;
...
import static com.demo.business.example.entity.DemoMongo.Props.*;
import static com.demo.config.init.BeanInitializer.Beans.mongoTemplate;
