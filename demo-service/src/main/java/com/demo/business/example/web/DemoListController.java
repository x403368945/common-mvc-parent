package com.demo.business.example.web;

import com.demo.business.example.entity.TabDemoList;
import com.demo.business.example.entity.TabDemoList.OrderBy;
import com.demo.business.example.enums.DemoStatus;
import com.demo.business.example.service.DemoListService;
                ...
                .version(this.getClass(), builder -> builder
                        ...
                        .demo(v -> v.setDemo(URL.SERVER.append(v.formatUrl()), // 当前接口参考案例请求地址；
                                TabDemoList.builder() // 当前接口参考案例请求参数，demo中设置支持查询的字段
                                        ...
                                        .createTimeRange(Dates.Range.month())
